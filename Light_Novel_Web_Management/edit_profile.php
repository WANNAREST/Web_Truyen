...
$email = isset($_SESSION['email']) ? htmlspecialchars($_SESSION['email']) : 'Không có email';
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
    // Xử lý nút "icon con mắt" cho trường Mật khẩu hiện tại
    ...
    // Xử lý nút "icon con mắt" cho trường Xác nhận mật khẩu mới
