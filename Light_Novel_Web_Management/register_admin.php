...
<body>
                ...
                <div class="col-md-6">
                    <div class="card mt-5 shadow-lg">
                        ...
                        <div class="card-footer text-center">
                            <a href="login_admin.php" class="text-decoration-none text-dark">Đã có tài khoản? <strong>Đăng nhập ngay</strong></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // Xử lý nút "icon con mắt" để hiển thị/ẩn mã xác thực
